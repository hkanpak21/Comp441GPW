#!/usr/bin/env python3
"""
KGW Watermark Experiments - All attacks

Usage:
    python exp_watermark_kgw.py --model opt-1.3b --num_samples 200
"""
...
def main():
    ...
    print("=" * 70)
    print(f"KGW WATERMARK EXPERIMENTS")
    print("=" * 70)
    ...
    output_csv = os.path.join(args.output_dir, f"results_kgw_{args.model}_{timestamp}.csv")
    ...
    for attack_name in attacks:
        ...
        for idx, (prompt, wm_text) in enumerate(zip(prompts, watermarked_texts)):
            ...
            try:
                ...
                row = {
                    'experiment_id': hashlib.md5(f"kgw_{attack_name}_{idx}".encode()).hexdigest()[:12],
    ...
    print("\n" + "=" * 70)
    print("KGW EXPERIMENTS COMPLETE")
    print("=" * 70)
