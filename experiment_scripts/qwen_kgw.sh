...
#SBATCH --mem=48G
#SBATCH --time=0:45:00
#SBATCH --output=/scratch/hkanpak21/Comp441GPW/logs/efficient/qwen_kgw_%j.out
#SBATCH --error=/scratch/hkanpak21/Comp441GPW/logs/efficient/qwen_kgw_%j.err

echo "=========================================="
echo "Qwen-7B: kgw watermarker"
echo "=========================================="
...
# Generate texts
echo "Generating 20 texts with kgw..."
...
# Find generated file
INPUT_FILE=$(ls -1t generated_texts/qwen-7b_kgw_*.pkl 2>/dev/null | head -1)
