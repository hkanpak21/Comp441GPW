#!/bin/bash
#SBATCH --job-name=qwen_gpw_sp_sr
...
echo "=========================================="
echo "Qwen-7B: gpw_sp_sr watermarker"
echo "=========================================="
...
# Generate texts
echo "Generating 20 texts with gpw_sp_sr..."
...
# Find generated file
INPUT_FILE=$(ls -1t generated_texts/qwen-7b_gpw_sp_sr_*.pkl 2>/dev/null | head -1)
