...
#SBATCH --mem=48G
#SBATCH --time=0:45:00
#SBATCH --output=/scratch/hkanpak21/Comp441GPW/logs/efficient/qwen_gpw_sp_%j.out
#SBATCH --error=/scratch/hkanpak21/Comp441GPW/logs/efficient/qwen_gpw_sp_%j.err

echo "=========================================="
echo "Qwen-7B: gpw_sp watermarker"
echo "=========================================="
...
# Generate texts
echo "Generating 20 texts with gpw_sp..."
...
# Find generated file
INPUT_FILE=$(ls -1t generated_texts/qwen-7b_gpw_sp_*.pkl 2>/dev/null | head -1)
